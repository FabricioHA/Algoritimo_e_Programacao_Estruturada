...
a melhor op��o � o fgets(), tambem do <stdio.h>, contendo a seguinte sintaxe:
...
/*Perceba que o fflush() � usado antes de declararmos o fgets(frase, 101, stdin).
Apesar de n�o ser obrigat�rio, � uma boa pr�tica para garantir que a entrada
